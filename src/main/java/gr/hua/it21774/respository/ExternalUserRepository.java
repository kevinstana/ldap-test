...
public interface ExternalUserRepository extends JpaRepository<ExternalUser, Long> {
    ...
    @Query("SELECT new gr.hua.it21774.dto.CommonUserDTO(u.id, e.username, u.email, u.firstName, u.lastName, u.createdAt, r.role, u.isEnabled, u.lastModified, lm.username AS lastModifiedBy) "
            + "FROM ExternalUser e "
